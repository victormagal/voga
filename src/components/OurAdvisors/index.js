...
export default function OurAdvisors() {
  return (
    <ContainerWithBackgroundImage uri='/bg-our-advisors.png'>
      <Container>
        <div className='lg:col-span-8 col-span-4 lg:col-start-3 flex flex-col items-center py-72'>
          <h1 className='font-bold text-5xl text-center text-white'>Conheça nossos assessores</h1>
