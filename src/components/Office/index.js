...
export default function Office({ id, title, excerpt, sourceImg, label, link }) {
  return (
    <Container key={id} className="bg-baby-blue mb-16 p-16 rounded-3xl">
      <div className='col-span-5'>
        <h1 className='font-bold text-dark-gray text-6xl'>{title}</h1>
        <div className='text-2xl my-12' dangerouslySetInnerHTML={{
          __html: excerpt
        }} />
