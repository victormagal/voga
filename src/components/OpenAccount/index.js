  ...
  return (
    <ContainerWithBackgroundImage uri='/bg-open-account.png'>
      <div className='col-span-6 col-start-4 flex flex-col items-center py-72'>
        ...
        <a className="bg-white block font-bold mt-12 py-6 rounded-full text-center text-2xl text-soft-blue uppercase w-1/2" href='#this' title='Abra sua conta'>Abra sua conta</a>
      </div>
