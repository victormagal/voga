    ...
    <ContainerWithBackgroundImage uri='/bg-open-account.png'>
      <Container>
        <div className='col-span-6 col-start-4 flex flex-col items-center py-72'>
          ...
          <a className="bg-white block font-bold mt-12 py-6 rounded-full text-center text-2xl text-soft-blue uppercase w-1/2" href='https://cadastro.xpi.com.br/desktop/step/1' target='_blank' rel='noreferrer' title='Abra sua conta'>Abra sua conta</a>
        </div>
      </Container>
